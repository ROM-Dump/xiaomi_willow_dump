...
cat cust/app/customized/partner-ru.yandex.searchplugin_45/partner-ru.yandex.searchplugin_45.apk.* 2>/dev/null >> cust/app/customized/partner-ru.yandex.searchplugin_45/partner-ru.yandex.searchplugin_45.apk
rm -f cust/app/customized/partner-ru.yandex.searchplugin_45/partner-ru.yandex.searchplugin_45.apk.* 2>/dev/null
